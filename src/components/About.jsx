...
export const About = () => {
  return (
    <section className='page__section about' id="about" aria-labelledby="about-title">
      <div className='wrapper'>
        <div className='about__content'>
          <div className="about__text-container">
            <h2 className='about__title' id="about-title">Our Story</h2>
          ...
          <div className="about__img-container" aria-hidden="true">
